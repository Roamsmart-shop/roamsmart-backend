...
class Order(db.Model):
    ...
    resolved_at = db.Column(db.DateTime, nullable=True)  # When the issue was resolved
    resolved_by = db.Column(db.Integer, db.ForeignKey('users.id'), nullable=True)  # Admin who resolved it
    resolution_note = db.Column(db.String(500), nullable=True)  # Notes about resolution
    ...
    def mark_resolved(self, admin_id, note=None):
